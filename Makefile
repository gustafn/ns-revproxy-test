...
all: 100KB 1MB 2MB 10MB 100MB
	...
	cp 100KB 1MB 2MB 10MB 100MB $(NS)/pages-backend/
	@echo 'Start servers:'
	...
	@echo '   curl -v -X GET --output /dev/null http://127.0.0.1:18091/10MB'
	@echo ''
	...
	@echo '   curl -v -X GET --output /dev/null http://127.0.0.1:18090/10MB'
	@echo ''
	...
	@echo '   curl -v -k -X GET --output /dev/null https://127.0.0.1:48090/10MB'
